...
<head>
  <title>ELECTRO HUB| Home :: Admin</title>
  <!-- Meta tag Keywords -->
...
<body>
      ...
      <header>
        <div class="container-fluid px-lg-5">
          ...
          <nav class="py-4 d-lg-flex">
            <div id="logo">
              <h1><a href="adminHome.php"> ELECTRO HUB</a></h1>
            </div>
            <label for="drop" class="toggle">Menu</label>
            <input type="checkbox" id="drop" />
            <ul class="menu mt-2 ml-auto">
              <li class="active"><a href="adminHome.php">Home</a></li>
              <li><a href="addStation.php" class="scroll">Add Station</a></li>
              <li><a href="addStation.php" class="scroll">Add Service</a></li>
              <li><a href="viewStation.php" class="scroll">View Station</a></li>
              <li><a href="viewService.php" class="scroll">View Service</a></li>
  ...
  <section class="banner-bottom-wthree py-5" id="about">
    <div class="container py-md-5 px-lg-5">
      ...
      <div class="content-right-bottom mt-md-0 mt-3 text-center">
        <p class="mt-2">
          Integer pulvinar leo id viverra feugiat.<strong class="text-capitalize">
            Pellentesque libero justo, semper at tempus vel, ultrices in sed
            ligula. Nulla uter sollicitudin velit.</strong>
          Sed porttitor orci vel fermentum elit maximus. Curabitur ut turpis
          massa in condimentum libero. Pellentesque maximus Pellentesque
          libero justo Nulla uter sollicitudin velit. Sed porttitor orci vel
          ferm semper at vel, ultrices in ligula semper at vel.
        </p>
        <p class="mt-3">
          <strong class="text-capitalize">Integer pulvinar leo id viverra feugiat.</strong>
          Pellentesque libero justo, semper at tempus vel, ultrices in sed
          ligula. Nulla uter sollicitudin velit. Sed porttitor orci vel ferm
          semper at vel, ultrices in ligula.
        </p>
      </div>
        ...
        <div class="col-lg-6 mid-right-content text-left mt-4">
          <div class="row">
            ...
            <div class="col-sm-8 mid-right-info">
              <h5 class="mb-4">Industrial Chemicals</h5>
              <p>
          ...
          <div class="row my-4">
            ...
            <div class="col-sm-8 mid-right-info">
              <h5 class="mb-4">Construction & Engineering</h5>
              <p>
                Lorem Ipsum has been the industry's standard since the 1500s.
                Praesent ullamcorper dui turpis.
              </p>
          ...
          <div class="row">
            ...
            <div class="col-sm-8 mid-right-info">
              <h5 class="mb-4">Basic & Industrial</h5>
              <p>
                Lorem Ipsum has been the industry's standard since the 1500s.
                Praesent ullamcorper dui turpis.
              </p>
    ...
    <div class="container">
      <div class="row text-center stats-content-w3pvt">
        <div class="col-lg-6 text-left pr-lg-5">
          <h3 class="tittle two mb-lg-5 mb-4">Stats</h3>
          <p>
            <strong class="text-capitalize">
              Pellentesque libero justo, semper at tempus vel, ultrices in sed
              ligula. Nulla uter sollicitudin velit.</strong>Lorem Ipsum has been the industry's standard since the 1500s.
            Praesent ullamcorper dui turpis.Nulla pellentesque mi non laoreet
          ...
          <div class="row">
            <div class="col-6 counter-gd">
              <div class="counter">
                ...
                <p class="count-text">Factories</p>
              </div>
            </div>
            <div class="col-6 counter-gd">
              <div class="counter">
  ...
  <section class="blog_w3ls py-5" id="blog">
    <div class="container py-xl-5 py-lg-3">
      <div class="header text-center">
        <h3 class="tittle mb-lg-5 mb-4">Blog Posts</h3>
      </div>
      <div class="row">
        <!-- blog grid -->
          ...
          <div class="card border-0 med-blog">
            <div class="card-body border border-bottom-0 pb-5">
              <div class="mb-3">
                ...
                <div class="blog_w3icon">
                  <span> Feb 14, 2019 - loremipsum</span>
                </div>
              </div>
              <p class="mb-4">
                Cras ultricies ligula sed magna dictum porta auris blandita.
          ...
          <div class="card border-0 med-blog">
            ...
            <div class="card-body border border-top-0 pb-5">
              <div class="mb-3">
                ...
                <div class="blog_w3icon">
                  <span> Feb 16, 2019 - loremipsum</span>
                </div>
              </div>
              <p class="mb-4">
                Cras ultricies ligula sed magna dictum porta auris blandita.
          ...
          <div class="card border-0 med-blog">
            ...
            <div class="card-body border border-top-0 pb-5">
              <div class="mb-3">
                ...
                <div class="blog_w3icon">
                  <span> Feb 18, 2019 - loremipsum</span>
                </div>
              </div>
              <p class="mb-4">
                Cras ultricies ligula sed magna dictum porta auris blandita.
          ...
          <div class="card border-0 med-blog">
            <div class="card-body border border-bottom-0 pb-5">
              <div class="mb-3">
                ...
                <div class="blog_w3icon">
                  <span> Feb 20, 2019 - loremipsum</span>
                </div>
              </div>
              <p class="mb-4">
                Cras ultricies ligula sed magna dictum porta auris blandita.
          ...
          <div class="card border-0 med-blog">
            ...
            <div class="card-body border border-top-0 pb-5">
              <div class="mb-3">
                ...
                <div class="blog_w3icon">
                  <span> Feb 24, 2019 - loremipsum</span>
                </div>
              </div>
              <p class="mb-4">
                Cras ultricies ligula sed magna dictum porta auris blandita.
    ...
    <div class="container py-md-3">
      ...
      <div class="row">
        <div class="col-md-6 test-info-w3ls text-left">
          ...
          <h3 class="my-md-2 my-3 text-left">Jenifer Burns</h3>
        ...
        <div class="col-md-6 test-info-w3ls text-left">
          ...
          <h3 class="my-md-2 my-3 text-left">Abraham Smith</h3>
            ...
            <div class="adress-info">
              <div class="row">
                ...
                <div class="col-9 text-left">
                  <h6>Location</h6>
                  <p>The company name <br />New York City.</p>
                </div>
              </div>
            </div>
      ...
      <div class="container-fluid">
        <div class="row footer-top-inner-w3ls">
          <div class="col-lg-4 col-md-6 footer-top mt-md-0 mt-sm-5">
            <h2>
              <a class="navbar-brand" href="../index.html"> Electricox </a>
            </h2>
            <p class="my-3">
          ...
          <div class="col-lg-3 col-md-6 mt-lg-0 mt-5">
            <div class="footer-w3pvt">
              ...
              <ul class="list-info-w3pvt">
                <li>
                  <a href="#about" class="scroll"> Our Mission </a>
                </li>
                <li class="my-2">
                  <a href="#blog" class="scroll"> Latest Posts </a>
                </li>
                <li class="my-2">
                  <a href="#"> Explore </a>
                </li>
                <li class="mb-2">
                  <a href="#contact" class="scroll"> Find us </a>
                </li>
                <li>
          ...
          <div class="col-lg-3 col-md-6 mt-lg-0 mt-5">
            <div class="footer-w3pvt">
              ...
              <div class="last-w3ls-contact">
                <p>+ 52 Donec consequat, <br />523 Loem Ipsum 049436.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <p class="copy-right-grids text-li text-center my-sm-4 my-4">
          © 2021 Electricox. All Rights Reserved | Design by
          <a href="#"> LCC </a>
        </p>
        ...
        <div class="move-top text-right">
          <a href="#home" class="move-top">
            <span class="fa fa-angle-up mb-3" aria-hidden="true"></span></a>
        </div>
      </div>
      <!-- //footer bottom -->
    </div>
