                ...
                <div class="container-fluid px-lg-5">
                    ...
                    <nav class="py-4 d-lg-flex">
                        ...
                        <ul class="menu mt-2 ml-auto">
                            ...
                            <li><a href="searchsatation.php" class="scroll">Search Satation</a></li>
                            ...
                            <li><a href="paidservices.php" class="scroll">My Paid Service</a></li>
                            <li><a href="feedbacks.php" class="scroll">Feedbacks</a></li>
