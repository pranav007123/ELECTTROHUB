...
<html lang="zxx">
  <head>
    <title>Electro Hub | Home :: User</title>
    <!-- Meta tag Keywords -->
    ...
    <!-- /Fonts -->
    <link
      href="//fonts.googleapis.com/css?family=Raleway:100,100i,200,200i,300,300i,400,400i,500,600,700"
      rel="stylesheet"
    />
    <link
      href="//fonts.googleapis.com/css?family=M+PLUS+Rounded+1c:100,300,400,500,700,800"
      rel="stylesheet"
    />
      ...
      <div class="layer">
        ...
        <header>
          <div class="container-fluid px-lg-5">
            ...
            <nav class="py-4 d-lg-flex">
              <div id="logo">
                <h1><a href="userHome.php"> Electro Hub</a></h1>
              </div>
              ...
              <ul class="menu mt-2 ml-auto">
                ...
                <li><a href="viewRequest.php" class="scroll">User Request</a></li>
        ...
        <div class="container">
          ...
          <div class="banner-info-w3layouts">
            ...
            <a href="single.html" class="read-more mt-3 btn">Read More </a>
          </div>
        </div>
      </div>
      <!-- //banner -->
        ...
        <div class="container-fluid">
          <div class="row footer-top-inner-w3ls">
            <div class="col-lg-4 col-md-6 footer-top mt-md-0 mt-sm-5">
              <h2>
                <a class="navbar-brand" href="../index.html"> Electro Hub </a>
              </h2>
              <p class="my-3">
          ...
          <p class="copy-right-grids text-li text-center my-sm-4 my-4">
            © 2019 Mechanized. All Rights Reserved | Design by
